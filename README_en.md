...
User configures call policy / lists
    ...
    → On scene enable, StateManager:
      · Writes SettingsData: focus_mode_profile, focus_mode_enable,
        ...
        (note: repeate is the historical spelling in source, not repeat; use this exact key)
...
| SettingsData | `focus_mode_repeate_callers_enable` | Whether a repeated caller within a short window may still ring.(note: repeate is the historical spelling in source, not repeat; use this exact key) |
